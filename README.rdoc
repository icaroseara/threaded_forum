== README
Threaded forum is an example of threaded discussion forum application.

{<img src="https://travis-ci.org/icaroseara/threaded_forum.svg" alt="Build Status" />}[https://travis-ci.org/icaroseara/threaded_forum]
